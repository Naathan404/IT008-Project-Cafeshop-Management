    ...
    public class CustomerViewModel : BaseViewModel
    {
        ...
        public CustomerDTO SelectedCustomer
        {
            ...
            set
            {
                ...
                {
                    TransactionHistory = new ObservableCollection<dynamic>();
                }
            }
        }

        // Danh sách lịch sử giao dịch
        private ObservableCollection<dynamic> _transactionHistory;
        public ObservableCollection<dynamic> TransactionHistory
        {
        ...
        private async Task LoadTransactionHistory(int customerId)
        {
            try
            {
                using (var db = new CoffeeShopContext())
                {
                    ...
                    TransactionHistory = new ObservableCollection<dynamic>(displayList);
                }
            }
            catch { }
        }
            ...
            using (var db = new CoffeeShopContext())
            {
                ...
                else // Cập nhật
                {
                    ...
                    if (cus != null)
                    {
                        ...
                        // Không cho sửa Điểm và Hạng ở đây (phải qua quy trình tích điểm)
                        await db.SaveChangesAsync();
