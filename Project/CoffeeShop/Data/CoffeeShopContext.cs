...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ActionTypeId).HasName("PK__ActionTy__62FE4C0479672470");
        ...
        {
            entity.HasKey(e => e.TableId).HasName("PK__CafeTabl__7D5F018E169240FA");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A2B29BD14C0");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B835810D39");

            entity.ToTable("Customer");

            entity.HasIndex(e => e.PhoneNumber, "UQ__Customer__85FB4E38546F7277").IsUnique();
        ...
        {
            entity.HasKey(e => e.DiscountId).HasName("PK__Discount__E43F6DF6F20EB16E");

            entity.ToTable("Discount");

            entity.HasIndex(e => e.DiscountCode, "UQ__Discount__A1120AF54E80118C").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaterialId).HasName("PK__Inventor__C50613170C4DEC5C");
        ...
        {
            entity.HasKey(e => e.HistoryId).HasName("PK__Inventor__4D7B4ADD997DFC7B");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__Item__727E83EB11CD0232");
        ...
        {
            entity.HasKey(e => e.PriceId).HasName("PK__ItemPric__4957584F50E374E8");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BAF5C7087F2");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30C85AC5E8D");
        ...
        {
            entity.HasKey(e => e.RequestId).HasName("PK__OTPReque__33A8519A54AB5682");
        ...
        {
            entity.HasKey(e => e.ShiftId).HasName("PK__Shift__C0A838E179EF91C8");
        ...
        {
            entity.HasKey(e => e.SizeId).HasName("PK__Size__83BD095A30E78A1A");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__Staff__96D4AAF7C8FC31F5");

            entity.HasIndex(e => e.Username, "UQ__Staff__536C85E44771D781").IsUnique();
